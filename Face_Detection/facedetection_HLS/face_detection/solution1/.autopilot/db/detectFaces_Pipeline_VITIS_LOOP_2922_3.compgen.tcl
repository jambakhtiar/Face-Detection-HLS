...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename result_x_Scale \
    op interface \
    ports { result_x_Scale_address0 { O 7 vector } result_x_Scale_ce0 { O 1 bit } result_x_Scale_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'result_x_Scale'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename result_y_Scale \
    op interface \
    ports { result_y_Scale_address0 { O 7 vector } result_y_Scale_ce0 { O 1 bit } result_y_Scale_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'result_y_Scale'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename result_w_Scale \
    op interface \
    ports { result_w_Scale_address0 { O 7 vector } result_w_Scale_ce0 { O 1 bit } result_w_Scale_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'result_w_Scale'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename result_h_Scale \
    op interface \
    ports { result_h_Scale_address0 { O 7 vector } result_h_Scale_ce0 { O 1 bit } result_h_Scale_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'result_h_Scale'"
}
}
