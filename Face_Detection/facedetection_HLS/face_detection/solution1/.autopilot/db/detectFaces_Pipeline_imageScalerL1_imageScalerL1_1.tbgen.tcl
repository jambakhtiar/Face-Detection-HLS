set moduleName detectFaces_Pipeline_imageScalerL1_imageScalerL1_1
set isTopModule 0
...
set C_modelName {detectFaces_Pipeline_imageScalerL1_imageScalerL1_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ y_ratio int 24 regular  }
	{ result_16 int 32 regular  }
	{ IMG1_data int 8 regular {array 76800 { 0 3 } 0 1 }  }
	{ result_15 int 32 regular  }
	{ sext_ln3417_1 int 28 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "y_ratio", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "result_16", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "IMG1_data", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "result_15", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "sext_ln3417_1", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ y_ratio sc_in sc_lv 24 signal 0 } 
	{ result_16 sc_in sc_lv 32 signal 1 } 
	...
	{ result_15 sc_in sc_lv 32 signal 3 } 
	{ sext_ln3417_1 sc_in sc_lv 28 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_16", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "result_16", "role": "default" }} , 
 	...
 	{ "name": "result_15", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "result_15", "role": "default" }} , 
 	{ "name": "sext_ln3417_1", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "sext_ln3417_1", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_9ns_28s_32_3_1_U4", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_8ns_24s_24_1_1_U5", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "76806", "Max" : "76806"}
	, {"Name" : "Interval", "Min" : "76806", "Max" : "76806"}
]}
...
set Spec2ImplPortList { 
	...
	result_16 { ap_none {  { result_16 in_data 0 32 } } }
	...
	result_15 { ap_none {  { result_15 in_data 0 32 } } }
	sext_ln3417_1 { ap_none {  { sext_ln3417_1 in_data 0 28 } } }
