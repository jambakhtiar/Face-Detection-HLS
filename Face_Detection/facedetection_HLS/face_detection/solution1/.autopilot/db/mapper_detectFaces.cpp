...
using hls::sim::Byte;
extern "C" void detectFaces(Byte<1>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, volatile void *);
extern "C" void apatb_detectFaces_hw(volatile void * __xlx_apatb_param_inData, volatile void * __xlx_apatb_param_result_x, volatile void * __xlx_apatb_param_result_y, volatile void * __xlx_apatb_param_result_w, volatile void * __xlx_apatb_param_result_h, volatile void * __xlx_apatb_param_result_size) {
...
__xlx_result_h__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_result_h)[i]);
  ...
  // DUT call
  detectFaces(__xlx_inData__tmp_vec.data(), __xlx_result_x__tmp_vec.data(), __xlx_result_y__tmp_vec.data(), __xlx_result_w__tmp_vec.data(), __xlx_result_h__tmp_vec.data(), __xlx_apatb_param_result_size);
